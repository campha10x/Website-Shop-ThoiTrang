<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="HangAdminaspx.aspx.cs" Inherits="ShopThoiTrang.Admin.HangAdminaspx" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    <asp:GridView ID="grvHang" runat="server" AutoGenerateColumns="False" ClientIDMode="Static" CssClass="table table-striped table-bordered table-hover" OnRowDataBound="grvTintuc_RowDataBound" OnSelectedIndexChanged="grvTintuc_SelectedIndexChanged">
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <div style="min-width: 19.5%; min-height: 10px; float: left;">
                                        <asp:ImageButton ID="lbAddSub" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="AddSub" ImageUrl="~/Admin/Images/add.png" OnCommand="lbAddSub_Command" Text="AddSub" ToolTip="Thêm Menu con" />
                                    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    <div class="row show-grid">
                        <div class="col-md-2">
                            <asp:Label ID="Label11" runat="server" Text="Label">Gía mới</asp:Label>
                        </div>
                    ...
                    <div class="row show-grid">
                        <div class="col-md-2">
                            <asp:Label ID="Label13" runat="server" Text="Label">Gía cũ</asp:Label>
                        </div>
